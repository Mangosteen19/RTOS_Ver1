...
void setup() { 
  ...
  xTaskCreate((TaskFunction_t )&Task_NEO,"Task4",2000,NULL,1,NULL);
//  xTaskCreate((TaskFunction_t )&Task_timer,"Task5",2000,NULL,1,NULL);
  timer = xTimerCreate("Software timer",pdMS_TO_TICKS(1000), pdTRUE, 0, (TimerCallbackFunction_t)Task_timer); //runRTC
  if (timer == NULL) {
